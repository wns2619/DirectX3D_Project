...
namespace Engine
{
	...
	enum CHANNELID { SOUND_SCARE1, SOUND_SCARE2, SOUND_SCARE3, SOUND_SCARE4, SOUND_SCARE5
		, SOUND_PICKUP, SOUND_ENVIRONMENT, SOUND_ENVIRONMENT2, SOUND_LIGHT1, SOUND_LIGHT2,
		SOUND_PLAYER, SOUND_RELOAD, SOUND_BULLET, SOUND_MONSTER, SOUND_BGM, SOUND_MAXCHANNEL, };
