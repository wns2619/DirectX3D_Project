...
namespace Engine
{
	...
	enum class LAYER_TAG { 
		...
		LAYER_BULLET, LAYER_TRIGER, LAYER_UI, LAYER_PARTICLE, LAYER_END, };
	...
	enum CHANNELID { SOUND_SCARE1, SOUND_SCARE2, SOUND_SCARE3, SOUND_SCARE4, SOUND_SCARE5
		, SOUND_PICKUP, 
		SOUND_ENVIRONMENT, SOUND_ENVIRONMENT2, SOUND_ENVIRONMENT3, SOUND_ENVIRONMENT4, SOUND_ENVIRONMENT5, SOUND_ENVIRONMENT6,
